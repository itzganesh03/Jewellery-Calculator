...
export interface CalculationInput { metal: Metal; purity: Purity; weight: number; makingPercent: number; makingChargeType: 'percent' | 'fixedRate'; hallmark: number; stone: number; rhodium: number; rate: number; }
...
export interface Settings { isDarkMode: boolean; currency: 'INR'; }
